import audio1 from "../assets/solutions/audioVideoSystems/1.jpg";
import audio2 from "../assets/solutions/audioVideoSystems/2.jpg";
import audio3 from "../assets/solutions/audioVideoSystems/3.jpg";
import audio4 from "../assets/solutions/audioVideoSystems/4.jpg";
import audio5 from "../assets/solutions/audioVideoSystems/5.jpg";
import audio6 from "../assets/solutions/audioVideoSystems/6.jpg";
import audio7 from "../assets/solutions/audioVideoSystems/7.jpg";
...
const audioVideo = {
  ...
  listTitle: "The most common types of AV systems include:",
  list: [
...
const fireDetection = {
  ...
  listTitle: "The most components of the Fire Detection Alarm System include:",
  list: [
...
const automaticEntrance = {
  id: 6,
  name: "Automatic Entrance Solutions",
  paragraph:
    "The most basic definition of any automatic entrance solutions is manual entrance equipped with a power-operated mechanism and controls that open and close the device automatically upon receipt of a momentary actuating signal.",
  listTitle: "The most common types of Automatic Entrance Solutions include:",
  list: [
    "Rising Pollards.",
    "Gate Barrier.",
    "Road Blocker.",
    ...
    "Tire Killer.",
    "Sliding Gate.",
    "Automatic Sliding / Swinging Doors.",
    "Speed PVC Doors.",
    "Shutter Gates.",
  ],
  pictures: [
...
const otherELV = {
  ...
  paragraph: "",
  listTitle:
    "Safe zone provide a several other ELV systems the most common of other ELV Solutions include:",
  list: [
    "Master Clock System.",
    "Tower Clock.",
